...
Le but du jeux est de contrôler le petit ninja à (l'aide des flèches du clavier/barre espace) rejoindre le temple afin qu'il puisse manger. Pour qu'il accède au temple, il va devoir monter sur les plateformes, et enclencher un levier afin de faire apparaître une plateforme permettant de rejoindre le temple.
...
Quelques images du rendu: ![Screenshot](FirstWindow.png)
...
# Remerciements
Pointe du chapeau à toute personne dont le code a été utilisé